"""
Django settings for cias_site project.
...
SECRET_KEY = '#p(49jbqqgmf3ru!-%@f28p0kfq!y80e)m_ymk@h*a02m+ac6r'
...
WSGI_APPLICATION = 'cias_site.wsgi.application'
